...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#f8f8fa]">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-5 mt-12">
          ...
          <button className="flex items-center justify-center gap-3 px-8 py-4 bg-orange-500 text-white rounded-xl font-semibold text-lg shadow-lg hover:bg-orange-600 transition">
           
            Download My CV
          </button>

          <button className="px-8 py-4 border border-gray-300 rounded-xl font-semibold text-[#08153f] hover:bg-white transition">
            View Projects
          </button>
